...
Opción 2: Formal en formato párrafo (Ideal para un informe, correo institucional o documento de entrega)
«Equipo portátil Lenovo ThinkPad T480 (PN: 20L6A0LJCL), cuyo hardware ha sido optimizado con una ampliación de memoria RAM a 24 GB y una unidad de almacenamiento SSD de 1 TB.»

Opción 3: Ficha técnica completa (Ideal para inventarios de TI o soporte técnico)
* Modelo: Lenovo ThinkPad T480
* Número de parte (P/N): 20L6A0LJCL
